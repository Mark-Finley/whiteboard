...
<div class="kpi-grid mb-4">
    ...
    <div class="card metric-card p-4">
        ...
        <div class="metric-value"><?php echo e($dischargedToday); ?></div>
    </div>
    <div class="card metric-card p-4">
        <div class="metric-label">Admitted Today</div>
        <div class="metric-value"><?php echo e($admittedToday); ?></div>
    </div>
</div>
...
<div class="card section-card">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <form class="row g-2 align-items-center" method="GET">
            <div class="col-auto"><input type="date" name="date" value="<?php echo e(request('date')); ?>" class="form-control"></div>
            <div class="col-auto">
...
if (activityCtx) {
    new Chart(activityCtx, {
        type: 'line',
        data: {
            labels: <?php echo json_encode($activityLabels, 15, 512) ?>,
            datasets: [
                {
                    label: 'Registered',
                    data: <?php echo json_encode($activityCreated, 15, 512) ?>,
                    borderColor: '#0f766e',
                ...
                {
                    label: 'Discharged',
                    data: <?php echo json_encode($activityDischarged, 15, 512) ?>,
                    borderColor: '<?php echo e($orangeColor); ?>',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/White Board/resources/views/dashboard/admin.blade.php ENDPATH**/ ?>