<header class="kepts-navbar sticky-top">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            ...
            <h1 class="page-title mb-0"><?php echo e($title ?? 'Dashboard'); ?></h1>
        </div>
    </div>
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <div class="dropdown">
            <button class="btn btn-ghost dropdown-toggle" data-bs-toggle="dropdown" type="button">
                <i class="fa-solid fa-user-circle me-2"></i><?php echo e(auth()->user()->name); ?>

            </button>
            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                <li><span class="dropdown-item-text small text-muted"><?php echo e(auth()->user()->role?->name); ?></span></li>
...
<div class="modal fade" id="searchModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content glass-card">
            ...
            <form action="<?php echo e(route('search')); ?>" method="GET" class="modal-body pt-0">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/White Board/resources/views/partials/navbar.blade.php ENDPATH**/ ?>